...
<div id="main">
                            ...
                            <div class="row col-md-12">
                              <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                        ...
                                        <div class="row mb-12 mb-2">
                                            <label for="comment" style="width:25%;"  class="col-sm-2 col-form-label">Comment</label>
                                            <div class="col-sm-6">
    ...
    event.preventDefault();
     ...
     let data =validasiinput(event);
      if(data !==false){
        ...
        $("#CreateAdd").fadeOut();
        $.ajax({
                url:"<?=base_url?>/Inventoriiad/Simpandata",
                method:"POST",
                dataType: "json",
                data:data,
  ...
  function SetTransno(){
    ...
    // Format the date using moment.js
      ...
      let id_trns ="WM"+thn+bln+rep_tgl3;
  ...
  function setData(result){
    ...
    $.each(result,function(a,b){
      ...
      datatabel +=`
                  ...
                  <td>${b.Quantity}</td>
                  <td>${b.keterangan}</td>`;
                  datatabel +=`<td><button   id="edit_row" onclick="edit_row('${transno}','${b.Itemno}','${b.transtype}','${b.warehouse}','${b.batchno}', 
