    ...
    let datatabel = ``;
        ...
        let no =1;
              $.each(result,function(a,b){
                ...
                datatabel +=`
                            <td>${no++}</td>
                            <td style="width:35%">${b.SoTransacID}<sup class='text-info'>${jml}</sup></td>
                            <td style="width:35%">${b.Shipdate}</td>
                            <td>${b.gudang}</td>
                            <td>${b.TypePart}</td>
                  ...
                  datatabel +=`<td>
                   ...
                   datatabel +=`<td>
                                        <form role="form" action="<?= base_url; ?>/inventori/viewposting" method="POST" target="_blank" enctype="multipart/form-data">
                                              <input type="hidden" class="form-control"name="SoTransacID" value ="${b.SoTransacID}">
                                              <input type="hidden" class="form-control"name="userid" value ="${b.UserId}">
