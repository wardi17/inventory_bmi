...
class FPDF_AutoWrapTable extends FPDF {
      ...
      private $options = array(
          ...
          'paper_size'=>'A4',
          'orientation'=>'L'
         // 'orientation'=>'P'  untuk ketas portrait
      );
    ...
    public function rptDetailData() {
        ...
        //header
			...
			$this->Cell(59 ,5,'View Inventory (Belum Diposting)',0,1);//end of line
            ...
            $this->SetX($left +=8); $this->Cell(20,$h,'Trans Type', 0, 0);
            $this->SetX($left +=20); $this->Cell(20,$h,'PartId', 0, 0);
            $this->SetX($left +=20); $this->Cell(50,$h,'Part Name', 0, 0);
            $this->SetX($left +=50); $this->Cell(25,$h,'Warehouse', 0, 0);
            $this->SetX($left +=25); $this->Cell(15,$h,'Qty',0, 0);
            $this->SetX($left +=15); $this->Cell(70,$h,'Comment',0, 1);
             $this->Cell(0,2, '', 0, 1,'C');
			 $this->Cell(0,0.1, '',1, 1,'C');
            $this->SetFont('Arial','',8);
            $this->SetDrawColor(255,255,255);
            $this->SetWidths(array(8,20,20,50,25,15,70));
