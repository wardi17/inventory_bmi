...
<div id="main">
    ...
    <div class ="col-md-12 col-12">
            ...
            <div class="card">
              ...
              <h5 class="text-center">Inventory Movement Posted</h5>
              </div>
              <div class="card-body">
  ...
  function get_Data(userid,tahun,cari){
    ...
    $.ajax({
                  url:"<?=base_url?>/sudahpost/sudahposting",
        ...
        let no =1;
              $.each(result,function(a,b){
                ...
                <td>${no++}</td>
                            ...
                            <td>${b.UserId}</td>`;
                  datatabel +=`<td>
                                        <form role="form" action="<?= base_url; ?>/sudahpost/viewposting" method="POST" target="_blank" enctype="multipart/form-data">
